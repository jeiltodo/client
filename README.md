...
<table>
  ...
  <tr>
    ...
    <td>할 일의 완료 처리 및 수정 삭제 기능, 노트 미리보기 및 작성 페이지로 이동</td>
  </tr>
  <tr>
    <td>그룹 대시보드</td>
...
👩‍💻지영 :  <br />
👩‍💻주연 : 기획부터 현재 배포까지 짧고 긴 시간안에 이만큼 한게 아직도 놀랍고, 이번기회에 타입스크립트와 테일윈드와 조금 친해진 것 같습니다. 그동안 겪은 트러블 슈팅들도 잘 정리해서 팀원분들과 함께 또 성장 하겠습니다!
-->
